...
<body>
    ...
    <section class="flex justify-center my-6 max-w-[1400px] mx-auto items-center md:px-4 sm:px-0">
        ...
        <h3 class="text-lg font-bold">Presidential Gifts – A Display of Diplomatic Excellence</h3>
        <p class="mb-3">Experience the art of diplomacy through the palace’s unique collection of <strong>Presidential Gifts</strong>. These symbolic tokens, exchanged between the UAE and other nations, represent the deep diplomatic ties and cultural appreciation shared with the world.</p>
        ...
        <ul class="list-disc pl-12 mb-3">
            ...
            <li><strong>Interactive Exhibits:</strong> Engage with displays showcasing centuries of knowledge.</li>
            <li><strong>Scenic Gardens:</strong> Walk through beautifully landscaped gardens offering breathtaking views.</li>
            <li><strong>Light Show:</strong> Experience the spectacular <em>Palace in Motion</em>, an unmissable visual event.</li>
        </ul>
