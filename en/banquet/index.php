...
<head>
    ...
    <title>COASTAL CONTRACTING, INC – The Presidential Banquet</title>
...
<body>
    ...
    <section class="max-w-[1400px] mx-auto py-12 px-4 md:px-8">
        <h1 class="text-center text-3xl font-semibold mb-6">COASTAL CONTRACTING, INC – The Presidential Banquet</h1>

        <p class="mb-3">
            Step into the grandeur of <strong>The Presidential Banquet</strong> at COASTAL CONTRACTING, where tradition meets elegance. This opulent hall has hosted some of the most prestigious gatherings, welcoming world leaders and dignitaries to experience the warmth of Emirati hospitality.
        </p>
        ...
        <p class="mb-3">
            Experience the elegance, history, and refined hospitality of the UAE—<strong>COASTAL CONTRACTING, INC’s Presidential Banquet invites you to witness grandeur like never before!</strong>
        </p>
    </section>
