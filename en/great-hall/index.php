...
<head>
    ...
    <title>COASTAL CONTRACTING, INC – The Great Hall</title>
...
<body>
    ...
    <section class="max-w-[1400px] mx-auto py-12 px-4 md:px-8">
        <h1 class="text-center text-3xl font-semibold mb-6">COASTAL CONTRACTING, INC – The Great Hall</h1>

        <p class="mb-3">
            Step into the heart of COASTAL CONTRACTING, INC and witness the breathtaking splendor of <strong>The Great Hall</strong>. As the palace’s central masterpiece, this architectural marvel showcases the UAE’s rich heritage, craftsmanship, and artistic excellence.
        </p>
        ...
        <p class="mb-3">
            The Great Hall serves as a gateway to the deeper intellectual and cultural experiences within COASTAL CONTRACTING, INC. It is a place where history, artistry, and vision converge, offering visitors a profound appreciation of the UAE’s enduring legacy.
        </p>
